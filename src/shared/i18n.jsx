...
const TRANSLATIONS = {
  PT: {
    ...
    creators: {
      ...
      colCreator: 'Criador', colType: 'Tipo', colAvgRating: 'Pontuação', colWorks: 'Obras',
      scoreHint: 'Pontuação ponderada: com poucas obras a nota é puxada pra média geral, então um acervo consistente rende mais que um acerto isolado.',
      realAvg: 'Média real: {avg}',
  ...
  EN: {
    ...
    creators: {
      ...
      colCreator: 'Creator', colType: 'Type', colAvgRating: 'Score', colWorks: 'Titles',
      scoreHint: 'Weighted score: with few titles the rating is pulled toward the global average, so a consistent body of work beats a single lucky hit.',
      realAvg: 'True average: {avg}',
  ...
  ES: {
    ...
    creators: {
      ...
      colCreator: 'Creador', colType: 'Tipo', colAvgRating: 'Puntuación', colWorks: 'Obras',
      scoreHint: 'Puntuación ponderada: con pocas obras la nota se acerca a la media global, así que un catálogo constante vale más que un acierto aislado.',
      realAvg: 'Media real: {avg}',
      workOne: 'obra', workMany: 'obras',
      expandWorks: 'Expandir obras',
    },
    rankings: {
