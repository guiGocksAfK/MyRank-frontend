...
const TRANSLATIONS = {
  PT: {
    ...
    chat: {
      ...
      mutualHint: 'DM só com quem te segue de volta. Grupos você monta com qualquer um.',
  ...
  EN: {
    ...
    chat: {
      ...
      mutualHint: 'DMs only with people who follow you back. Groups can include anyone.',
  ...
  ES: {
    ...
    chat: {
      ...
      mutualHint: 'DM solo con quien te sigue de vuelta. Los grupos admiten a cualquiera.',
