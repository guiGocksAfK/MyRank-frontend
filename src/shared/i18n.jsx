...
const TRANSLATIONS = {
  PT: {
    ...
    chat: {
      ...
      mutualHint: 'Você só troca mensagens com quem segue e te segue de volta.',
  ...
  EN: {
    ...
    chat: {
      ...
      mutualHint: 'You can only message people you follow who follow you back.',
  ...
  ES: {
    ...
    chat: {
      ...
      mutualHint: 'Solo puedes escribir a quienes sigues y te siguen de vuelta.',
