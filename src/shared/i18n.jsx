  ...
  PT: {
    ...
    social: {
      ...
      feed: {
        ...
        emptyText: 'Siga pessoas (ou perfis públicos) pra ver os takes que elas postam.',
      ...
      comments: {
        ...
        showReplies: 'Ver {n} respostas',
        hideReplies: 'Ocultar respostas',
      },
      take: {
        edit: 'Editar take', delete: 'Excluir take',
        save: 'Salvar', cancel: 'Cancelar',
        edited: '(editado)',
        deleteTitle: 'Excluir take?',
        confirmDelete: 'Este take e todos os seus comentários e reações serão apagados. Não dá pra desfazer.',
      },
      act: {
        rated: 'avaliou',
    ...
    chat: {
      ...
      deleteGroupMsg: 'O grupo, todas as mensagens e os membros serão removidos. Não dá pra desfazer.',
      deleteGroupCta: 'Excluir grupo',
      close: 'Fechar',
    ...
    creators: {
      ...
      colCreator: 'Criador', colType: 'Tipo', colAvgRating: 'Média', colWorks: 'Obras',
      realAvg: 'Média das notas: {avg}',
    ...
    profile: {
      ...
      apis: {
        ...
        mal: 'MyAnimeList — títulos de anime, capas, número de episódios, estúdios e ranking de popularidade.',
        books: 'Google Books — livros com capa, autores, sinopse, editora e número de páginas.',
        gemini: 'Modelo de linguagem do Google que gera a análise do seu perfil na aba IA Insights.',
      },
  ...
  EN: {
    ...
    social: {
      ...
      feed: {
        ...
        emptyText: 'Follow people (or public profiles) to see the takes they post.',
      ...
      comments: {
        ...
        edited: '(edited)',
        replyingTo: 'Replying',
        showReplies: 'View {n} replies',
        hideReplies: 'Hide replies',
      },
      take: {
        edit: 'Edit take', delete: 'Delete take',
        save: 'Save', cancel: 'Cancel',
        edited: '(edited)',
        deleteTitle: 'Delete take?',
        confirmDelete: 'This take and all its comments and reactions will be removed. This cannot be undone.',
      },
      act: {
        rated: 'rated',
    ...
    chat: {
      ...
      deleteGroupMsg: 'The group, all its messages and members will be removed. This cannot be undone.',
    ...
    creators: {
      ...
      colCreator: 'Creator', colType: 'Type', colAvgRating: 'Average', colWorks: 'Titles',
      realAvg: 'Ratings average: {avg}',
    ...
    profile: {
      ...
      apis: {
        ...
        mal: 'MyAnimeList — anime titles, cover art, episode counts, studios and popularity ranking.',
        books: 'Google Books — books with cover, authors, synopsis, publisher and page count.',
        gemini: "Google's language model that generates your profile analysis in the AI Insights tab.",
      },
  ...
  ES: {
    ...
    social: {
      ...
      feed: {
        ...
        emptyText: 'Sigue a gente (o perfiles públicos) para ver los takes que publican.',
        emptyCta: 'Descubrir gente',
      },
      comments: {
        label: 'Comentar',
        loading: 'Cargando comentarios…',
        empty: 'Sin comentarios todavía. Sé el primero.',
        ...
        cancel: 'Cancelar',
        edited: '(editado)',
        replyingTo: 'Respondiendo',
        showReplies: 'Ver {n} respuestas',
        hideReplies: 'Ocultar respuestas',
      },
      take: {
        edit: 'Editar take', delete: 'Eliminar take',
        save: 'Guardar', cancel: 'Cancelar',
        edited: '(editado)',
        deleteTitle: '¿Eliminar take?',
        confirmDelete: 'Este take y todos sus comentarios y reacciones se eliminarán. No se puede deshacer.',
      },
      act: {
        rated: 'valoró',
    ...
    chat: {
      ...
      deleteGroupMsg: 'El grupo, todos sus mensajes y miembros se eliminarán. No se puede deshacer.',
      deleteGroupCta: 'Eliminar grupo',
      close: 'Cerrar',
    ...
    creators: {
      ...
      colCreator: 'Creador', colType: 'Tipo', colAvgRating: 'Media', colWorks: 'Obras',
      realAvg: 'Media de las notas: {avg}',
      workOne: 'obra', workMany: 'obras',
      expandWorks: 'Expandir obras',
    },
    rankings: {
    ...
    profile: {
      ...
      apis: {
        ...
        mal: 'MyAnimeList — títulos de anime, carátulas, número de episodios, estudios y ranking de popularidad.',
        books: 'Google Books — libros con portada, autores, sinopsis, editorial y número de páginas.',
        gemini: 'Modelo de lenguaje de Google que genera el análisis de tu perfil en la pestaña IA Insights.',
      },
