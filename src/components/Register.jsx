...
const Register = () => {
  ...
  return (
    <main className="auth-page">
      ...
      <section className="auth-hero auth-hero--scroll" aria-label="Cadastrar no MyRank">
        <div className="auth-copy">
          <p className="auth-kicker">MyRank</p>
          <h1>Crie sua conta no MyRank</h1>
          <p>
            Comece grátis, monte suas tabelas e transforme seu gosto em um
            ranking com identidade própria.
          </p>
        ...
        <form className="auth-card">
          ...
          <button className="auth-submit" style={{ marginTop: "24px" }} type="submit">
            Criar conta
          </button>
          ...
          <p className="auth-signup-note">
            Já possui uma conta?{" "}
            <Link to="/entrar">Entre aqui</Link>
          </p>
        </form>
      </section>
    </main>
